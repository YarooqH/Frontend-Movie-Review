...
function Review() {
    ...
    const getReview = async () => {
        ...
        refimg.current = data.reviewimg.data.attributes.name;
    }
       ...
       <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">        
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap justify-center">
            <img alt={refReview.current.title} className="review-img h-[40rem] object-cover object-center rounded" src={refimg.current}/>
